...
display(spark.sql(f"SELECT window, window_cmp, column_name, * FROM {dm_info.assets.drift_metrics_table_name} WHERE COLUMN_NAME IN ('price') AND slice_key is NULL"))
